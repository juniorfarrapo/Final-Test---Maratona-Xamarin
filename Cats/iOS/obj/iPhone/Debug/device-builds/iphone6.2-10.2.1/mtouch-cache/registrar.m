...
@implementation AppDelegate { } 
	...
	{
		static MonoMethod *managed_method = NULL;
		return native_to_managed_trampoline_7 (self, _cmd, &managed_method, p0, p1, "UIKit.UIApplication, Xamarin.iOS", "Foundation.NSDictionary, Xamarin.iOS", "Cats.iOS.AppDelegate, Cats.iOS", "FinishedLaunching");
	}
	...
	-(id) init
	{
		static MonoMethod *managed_method = NULL;
		bool call_super = false;
		id rv = native_to_managed_trampoline_9 (self, _cmd, &managed_method, "Cats.iOS.AppDelegate, Cats.iOS", ".ctor", &call_super);
		if (call_super && rv) {
...
@implementation Xamarin_Auth__MobileServices_FormAuthenticatorController_FormDelegate { } 
	...
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_99 (self, _cmd, &managed_method, p0, p1, "UIKit.UITableView, Xamarin.iOS", "Foundation.NSIndexPath, Xamarin.iOS", "Xamarin.Auth._MobileServices.FormAuthenticatorController+FormDelegate, Microsoft.WindowsAzure.Mobile.Ext", "RowSelected");
	}
...
@implementation Xamarin_Auth__MobileServices_FormAuthenticatorController_FormDataSource { } 
	...
	{
		static MonoMethod *managed_method = NULL;
		return native_to_managed_trampoline_98 (self, _cmd, &managed_method, p0, "UIKit.UITableView, Xamarin.iOS", "Xamarin.Auth._MobileServices.FormAuthenticatorController+FormDataSource, Microsoft.WindowsAzure.Mobile.Ext", "NumberOfSections");
	}

	-(NSInteger) tableView:(UITableView *)p0 numberOfRowsInSection:(NSInteger)p1
	{
		static MonoMethod *managed_method = NULL;
		return native_to_managed_trampoline_100 (self, _cmd, &managed_method, p0, p1, "UIKit.UITableView, Xamarin.iOS", "System.nint, Xamarin.iOS", "Xamarin.Auth._MobileServices.FormAuthenticatorController+FormDataSource, Microsoft.WindowsAzure.Mobile.Ext", "RowsInSection");
	}

	-(UITableViewCell *) tableView:(UITableView *)p0 cellForRowAtIndexPath:(NSIndexPath *)p1
	{
		static MonoMethod *managed_method = NULL;
		return native_to_managed_trampoline_95 (self, _cmd, &managed_method, p0, p1, "UIKit.UITableView, Xamarin.iOS", "Foundation.NSIndexPath, Xamarin.iOS", "Xamarin.Auth._MobileServices.FormAuthenticatorController+FormDataSource, Microsoft.WindowsAzure.Mobile.Ext", "GetCell");
	}
...
@end
	...
	static MTClassMap __xamarin_class_map [] = {
		...
		{"AppDelegate", "Cats.iOS.AppDelegate, Cats.iOS", NULL },
...
void xamarin_create_classes () {
	...
	__xamarin_class_map [17].handle = objc_getClass ("UICubicTimingParameters");
	...
	__xamarin_class_map [28].handle = objc_getClass ("NSTimeZone");
	...
	__xamarin_class_map [37].handle = objc_getClass ("UIFontDescriptor");
	...
	__xamarin_class_map [45].handle = objc_getClass ("UIImage");
	__xamarin_class_map [46].handle = objc_getClass ("CSSearchableIndex");
	...
	__xamarin_class_map [54].handle = objc_getClass ("UIBarItem");
	__xamarin_class_map [55].handle = objc_getClass ("UIBezierPath");
	__xamarin_class_map [56].handle = objc_getClass ("UIButton");
	...
	__xamarin_class_map [69].handle = objc_getClass ("ACAccount");
	__xamarin_class_map [70].handle = objc_getClass ("ACAccountStore");
	...
	__xamarin_class_map [82].handle = objc_getClass ("NSNotification");
	__xamarin_class_map [83].handle = objc_getClass ("NSNull");
	__xamarin_class_map [84].handle = objc_getClass ("UITabBarItem");
	...
	__xamarin_class_map [91].handle = objc_getClass ("UITouch");
	__xamarin_class_map [92].handle = objc_getClass ("UIUserNotificationSettings");
	__xamarin_class_map [93].handle = objc_getClass ("NSURLCache");
	...
	__xamarin_class_map [97].handle = objc_getClass ("UIAlertController");
	__xamarin_class_map [98].handle = objc_getClass ("UIActivityIndicatorView");
	__xamarin_class_map [99].handle = objc_getClass ("NSTextAttachment");
	__xamarin_class_map [100].handle = objc_getClass ("NSTextContainer");
	...
	__xamarin_class_map [103].handle = objc_getClass ("UIBlurEffect");
	...
	__xamarin_class_map [108].handle = objc_getClass ("UIApplicationShortcutItem");
	...
	__xamarin_class_map [120].handle = objc_getClass ("UILongPressGestureRecognizer");
	__xamarin_class_map [121].handle = objc_getClass ("UINavigationBar");
	__xamarin_class_map [122].handle = objc_getClass ("UIActionSheet");
	__xamarin_class_map [123].handle = objc_getClass ("UIAlertView");
	__xamarin_class_map [124].handle = objc_getClass ("UIApplication");
	...
	__xamarin_class_map [150].handle = objc_getClass ("UIKit_UIActionSheet__UIActionSheetDelegate");
	__xamarin_class_map [151].handle = objc_getClass ("UIKit_UIAlertView__UIAlertViewDelegate");
	__xamarin_class_map [152].handle = objc_getClass ("UIKit_UIBarButtonItem_Callback");
	...
	__xamarin_class_map [155].handle = objc_getClass ("__UIPanGestureRecognizer");
	__xamarin_class_map [156].handle = objc_getClass ("__UIPinchGestureRecognizer");
	__xamarin_class_map [157].handle = objc_getClass ("__UISwipeGestureRecognizer");
	__xamarin_class_map [158].handle = objc_getClass ("__UIScreenEdgePanGestureRecognizer");
	...
	__xamarin_class_map [193].handle = [Xamarin_Forms_Platform_iOS_NativeViewPropertyListener class];
	...
	__xamarin_class_map [202].handle = [Xamarin_Forms_Platform_iOS_ToolbarItemExtensions_PrimaryToolbarItem class];
	__xamarin_class_map [203].handle = [Xamarin_Forms_Platform_iOS_ButtonRenderer class];
	__xamarin_class_map [204].handle = [Xamarin_Forms_Platform_iOS_CarouselPageRenderer_PageContainer class];
	__xamarin_class_map [205].handle = [Xamarin_Forms_Platform_iOS_CarouselPageRenderer class];
	__xamarin_class_map [206].handle = [Xamarin_Forms_Platform_iOS_DatePickerRenderer class];
	__xamarin_class_map [207].handle = [Xamarin_Forms_Platform_iOS_ImageRenderer class];
	__xamarin_class_map [208].handle = [Xamarin_Forms_Platform_iOS_ListViewRenderer_ListViewDataSource class];
	__xamarin_class_map [209].handle = [Xamarin_Forms_Platform_iOS_ListViewRenderer_UnevenListViewDataSource class];
	__xamarin_class_map [210].handle = [Xamarin_Forms_Platform_iOS_ListViewRenderer class];
	__xamarin_class_map [211].handle = [Xamarin_Forms_Platform_iOS_NavigationMenuRenderer_NavigationCell class];
	__xamarin_class_map [212].handle = [Xamarin_Forms_Platform_iOS_NavigationMenuRenderer class];
	__xamarin_class_map [213].handle = [Xamarin_Forms_Platform_iOS_NavigationRenderer_ParentingViewController class];
	__xamarin_class_map [214].handle = [Xamarin_Forms_Platform_iOS_NavigationRenderer class];
	__xamarin_class_map [215].handle = [Xamarin_Forms_Platform_iOS_OpenGLViewRenderer_Delegate class];
	__xamarin_class_map [216].handle = [Xamarin_Forms_Platform_iOS_OpenGLViewRenderer class];
	__xamarin_class_map [217].handle = [Xamarin_Forms_Platform_iOS_PageRenderer class];
	__xamarin_class_map [218].handle = [Xamarin_Forms_Platform_iOS_PhoneMasterDetailRenderer_ChildViewController class];
	__xamarin_class_map [219].handle = [Xamarin_Forms_Platform_iOS_PhoneMasterDetailRenderer class];
	__xamarin_class_map [220].handle = [Xamarin_Forms_Platform_iOS_PickerRenderer_PickerSource class];
	__xamarin_class_map [221].handle = [Xamarin_Forms_Platform_iOS_PickerRenderer class];
	__xamarin_class_map [222].handle = [Xamarin_Forms_Platform_iOS_TabletMasterDetailRenderer_InnerDelegate class];
	__xamarin_class_map [223].handle = [Xamarin_Forms_Platform_iOS_TabletMasterDetailRenderer class];
	__xamarin_class_map [224].handle = [Xamarin_Forms_Platform_iOS_TimePickerRenderer class];
	__xamarin_class_map [225].handle = [Xamarin_Forms_Platform_iOS_WebViewRenderer_CustomWebViewDelegate class];
	__xamarin_class_map [226].handle = [Xamarin_Forms_Platform_iOS_WebViewRenderer class];
	...
	__xamarin_class_map [231].handle = [Xamarin_Controls__MobileServices_ProgressLabel class];
	__xamarin_class_map [232].handle = [Xamarin_Auth__MobileServices_FormAuthenticatorController_FormDelegate class];
	__xamarin_class_map [233].handle = [Xamarin_Auth__MobileServices_FormAuthenticatorController class];
	__xamarin_class_map [234].handle = [Xamarin_Auth__MobileServices_WebAuthenticatorController_WebViewDelegate class];
	__xamarin_class_map [235].handle = [Xamarin_Auth__MobileServices_WebAuthenticatorController class];
	__xamarin_class_map [236].handle = [Xamarin_Auth__MobileServices_FormAuthenticatorController_FieldCell class];
	__xamarin_class_map [237].handle = [Xamarin_Auth__MobileServices_FormAuthenticatorController_FormDataSource class];
